...
const AUTH_API = 'http://Daycare-backend-env.eba-vf6pffb7.eu-west-1.elasticbeanstalk.com/api/auth';
const ATTENDANCE_API = 'http://Daycare-backend-env.eba-vf6pffb7.eu-west-1.elasticbeanstalk.com/api/attendance';
