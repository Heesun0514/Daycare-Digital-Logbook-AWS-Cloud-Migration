...
const AUTH_API = 'https://Daycare-backend-env.eba-jpr72kpf.eu-west-1.elasticbeanstalk.com/api/auth';
const ATTENDANCE_API = 'https://Daycare-backend-env.eba-jpr72kpf.eu-west-1.elasticbeanstalk.com/api/attendance';
